    ...
    <div className="dashboard">
      ...
      <section className="dash-hero">
        <div className="dash-hero-board" aria-hidden="true">
          {Array.from({ length: 64 }, (_, i) => (
            <div
              key={i}
              className={`dash-sq ${(Math.floor(i / 8) + i) % 2 === 0 ? 'light' : 'dark'}`}
            />
          ))}
          {/* Decorative pieces on the mini board */}
        ...
        <div className="dash-hero-text">
          <p className="dash-hero-eyebrow">Welcome to</p>
      ...
      <section className="dash-modes">
        ...
        <div className="dash-cards">
          ...
          <button className="dash-card dash-card--primary" onClick={() => onNavigate('pvp')}>
...
const DECORATIVE_PIECES = [
  { sq: 'e8', symbol: '♚', cls: 'p-black' },
  { sq: 'd8', symbol: '♛', cls: 'p-black' },
  { sq: 'a8', symbol: '♜', cls: 'p-black' },
  { sq: 'h8', symbol: '♜', cls: 'p-black' },
  { sq: 'b8', symbol: '♞', cls: 'p-black' },
  { sq: 'g8', symbol: '♞', cls: 'p-black' },
  { sq: 'c8', symbol: '♝', cls: 'p-black' },
  { sq: 'f8', symbol: '♝', cls: 'p-black' },
  { sq: 'e1', symbol: '♔', cls: 'p-white' },
  { sq: 'd1', symbol: '♕', cls: 'p-white' },
  { sq: 'a1', symbol: '♖', cls: 'p-white' },
  { sq: 'h1', symbol: '♖', cls: 'p-white' },
  { sq: 'e4', symbol: '♟', cls: 'p-black' },
  { sq: 'd5', symbol: '♙', cls: 'p-white' },
]

const RULES = [
  { icon: '🖱️', title: 'Drag or click', desc: 'Drag a piece to move it, or click to select then click a destination.' },
  { icon: '🟡', title: 'Valid moves', desc: 'Yellow = selected piece. Orange = squares you can move to.' },
  { icon: '🔴', title: 'Blocked squares', desc: 'Red highlights show squares occupied by your own pieces.' },
  { icon: '🟢', title: 'Last move', desc: 'Green highlights show the most recent move made.' },
  { icon: '⚔️', title: 'Captures', desc: 'Move onto an enemy piece to capture it. Tracked in the side panel.' },
